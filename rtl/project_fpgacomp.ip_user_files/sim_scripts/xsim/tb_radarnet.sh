...
#
# Script generated by Vivado on Tue Mar 17 13:48:17 +0530 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_radarnet.sh
...
#
# Usage        : tb_radarnet.sh
#                tb_radarnet.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_radarnet.sh [-rerun]
#                tb_radarnet.sh [-reset_run]
#                tb_radarnet.sh [-clean]
#                tb_radarnet.sh [-reset_log]
#                tb_radarnet.sh [-help]
#
...
# script info
echo -e "tb_radarnet.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_radarnet.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_12 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb_radarnet xil_defaultlib.tb_radarnet xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_radarnet -key {Behavioral:sim_1:Functional:tb_radarnet} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_radarnet.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_radarnet.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_radarnet.sh [-help]\n\
Usage: tb_radarnet.sh [-step]\n\
Usage: tb_radarnet.sh [-lib_map_path]\n\
Usage: tb_radarnet.sh [-rerun]\n\
Usage: tb_radarnet.sh [-reset_run]\n\
Usage: tb_radarnet.sh [-clean]\n\
Usage: tb_radarnet.sh [-reset_log]\n\
Usage: tb_radarnet.sh [-keep_index]\n\
Usage: tb_radarnet.sh [-noclean_files]\n\n\
