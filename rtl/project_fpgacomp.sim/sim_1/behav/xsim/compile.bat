...
REM
REM Generated by Vivado on Wed Mar 18 13:54:19 +0530 2026
...
echo "xvlog --incr --relax -prj tb_radarnet_vlog.prj"
call xvlog  --incr --relax -prj tb_radarnet_vlog.prj -log xvlog.log
